...
module.exports.moduleViewURL = "/docs/fin";
...
module.exports.init = function(app){
    ...
    var tFinTableColumns=[
        ...
        {data:"EmpID", name:"ИД Сотр.", width:0, type:"text", align:"center", visible:false, dataSource:"t_Sale"},
        {data:"Emp", name:"Сотрудник", width:150, type:"text", align:"center", dataSource:"t_Sale"},
    ...
    var tempStore= [];
    app.get("/docs/fin/getFinDataForTable", function(req, res){
        ...
        //        res.send(result);
        //    });
        tempStore= systemFuncs.loadDataFromFile("/temp/tempStore.json");
    ...
    app.post("/docs/fin/storeFinTableData",function(req,res){                                            console.log("data",req.body);
        var data= req.body;
        if(data){
            var chID= data["ChID"];
            if(chID==null){//append
        ...
        systemFuncs.saveDataToFile("/temp/tempStore.json",tempStore);
